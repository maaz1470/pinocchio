	...
	if (!Array.prototype.forEach)
		...
		markersData = {
			'Historic': [
			{
				...
				map_image_url: 'img/thumb_map_historic_1.webp',
				...
				map_image_url: 'img/thumb_map_historic_2.webp',
			...
			},
			{
				...
				map_image_url: 'img/thumb_map_historic_3.webp',
				name_point: 'Pantheon',
				description_point: 'Lorem Ipsum is simply dummy text of the printing and typesetting industry.',
				get_directions_start_address: '',
				phone: '+3934245255',
			...
			'Sightseeing': [
			{
				...
				map_image_url: 'img/thumb_map_sightseeing_1.webp',
				name_point: 'Open Bus',
				description_point: 'Lorem Ipsum is simply dummy text of the printing and typesetting industry.',
				get_directions_start_address: '',
				phone: '+3934245255',
			...
			'Museums': [
			{
				...
				map_image_url: 'img/thumb_map_museums_1.webp',
				name_point: 'Louvre',
				description_point: 'Lorem Ipsum is simply dummy text of the printing and typesetting industry.',
				get_directions_start_address: '',
				phone: '+3934245255',
			...
			'Skyline': [
			{
				...
				map_image_url: 'img/thumb_map_skyline_1.webp',
			...
			'Walking': [
			{
				...
				map_image_url: 'img/thumb_map_walking_1.webp',
				name_point: 'Pompidou',
				description_point: 'Lorem Ipsum is simply dummy text of the printing and typesetting industry.',
				get_directions_start_address: '',
				phone: '+3934245255',
			...
			'Churches': [
			{
				...
				map_image_url: 'img/thumb_map_churches_1.webp',
