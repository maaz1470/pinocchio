	...
	if (!Array.prototype.forEach)
		...
		markersData = {
			'Fastfood': [
			{
				...
				map_image_url: 'img/thumb_map_fastfood_1.webp',
			...
			},
			{
				...
				map_image_url: 'img/thumb_map_fastfood_2.webp',
				name_point: 'Catrine',
				description_point: 'Lorem Ipsum is simply dummy text of the printing and typesetting industry.',
				get_directions_start_address: '',
				phone: '+3934245255',
			...
			'Pizza': [
			{
				...
				map_image_url: 'img/thumb_map_pizza_1.webp',
			...
			'Chinese': [
			{
				...
				map_image_url: 'img/thumb_map_chinese_1.webp',
			...
			'Fish': [
			{
				...
				map_image_url: 'img/thumb_map_fish_1.webp',
				name_point: 'SeaFood',
				description_point: 'Lorem Ipsum is simply dummy text of the printing and typesetting industry.',
				get_directions_start_address: '',
				phone: '+3934245255',
			...
			'International': [
			{
				...
				map_image_url: 'img/thumb_map_international_1.webp',
				name_point: 'Alfredo',
				description_point: 'Lorem Ipsum is simply dummy text of the printing and typesetting industry.',
				get_directions_start_address: '',
				phone: '+3934245255',
			...
			},
			{
				...
				map_image_url: 'img/thumb_map_international_2.webp',
			...
			},
			{
				...
				location_latitude: 48.858370, 
				location_longitude: 2.294481,
				map_image_url: 'img/thumb_map_international_3.webp',
