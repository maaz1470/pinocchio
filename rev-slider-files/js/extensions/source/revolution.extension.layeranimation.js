	...
	endMoveCaption : function(obj) {
		...
		if (!nc.static || (obj.currentslide>=nc.removeonslide) || (obj.currentslide<nc.showonslide)) {		
			...
			if (_.visibleelement===true)
				_R.createFrameOnTimeline({caption:obj.caption, timeline : nc.outnow, label:"outnow", frameindex : obj.caption.data("outframe/"), opt:obj.opt, fromcurrentstate:true}).play();	 		
		}		
